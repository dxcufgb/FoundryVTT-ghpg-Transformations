export function createLocalTransformationMutationAdapter({actorRepository, getTransformationQueryService, itemRepository, creatureTypeService, compendiumRepository, stageGrantResolver, actionExecutor, logger}) {
    ...
    async function advanceStage({actorId, stage}) {
        ...
        const {definition} = getTransformationQueryService().getForActor(actor);
