...
})
{
    ...
    return Object.freeze({
        ...
        {
            logger.debug("createHagMacroHandlers.chitinousShell", { actor, trigger })
        ...
        {
            logger.debug("createHagMacroHandlers.eldritchLimbs", { actor, trigger })
            return tracker.track(
                (async () =>
                {
                    if (trigger !== "on") return
        ...
        {
            logger.debug("createHagMacroHandlers.slimyForm", { actor, trigger })
            return tracker.track(
                (async () =>
                {
                    if (trigger !== "on") return
        ...
        {
            logger.debug("createHagMacroHandlers.removeAberrantMutationEffects", { actor, trigger })
            return tracker.track(
                (async () =>
                {
    ...
    {
        logger.debug("createHagMacroHandlers.addEldritchLimbsItem", { actor })
        return tracker.track(
            (async () =>
            {
    ...
    {
        logger.debug("createHagMacroHandlers.removeEldritchLimbsItem", { actor })
        return tracker.track(
            (async () =>
            {
                if (actorHasEfficientKiller(actor)) {
    ...
    {
        logger.debug("createHagMacroHandlers.actorHasEfficientKiller", { actor })
